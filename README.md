...
```
3. Hardcoded predefined default value in [Config.js module](https://github.com/shustariov-andrey/requangular-boilerplate/blob/master/src/cmn/core/config/Config.js#L7)
